  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-4">
        <div>
          <h2 className="text-[clamp(16px,4vw,20px)] font-extrabold text-ksp-navy m-0 uppercase tracking-tight">Police Stations Directory</h2>
          <p className="text-[clamp(10px,2vw,12px)] text-slate-500 font-bold uppercase tracking-wider mt-1">Manage state police stations and geographic locations</p>
        </div>
        <button 
          onClick={handleOpenAdd}
          className="bg-ksp-navy hover:bg-ksp-navy-light text-white text-[10px] sm:text-xs font-bold px-4 py-2.5 rounded-lg flex items-center gap-1.5 shadow border border-ksp-gold/25"
        >
