  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-slate-50 select-none w-full">
      ...
      <div className="dashboard-layout">
        ...
        <aside className={`
          fixed-sidebar hidden xl:flex bg-ksp-navy text-white flex-col border-r border-slate-700 shadow-2xl select-none z-30
        `}>
          ...
          <nav className="flex-grow min-h-0 p-4 pb-8 space-y-1.5 overflow-hidden">
            {menuItems.map((item) => {
