...
export type ToolName = 'executeDatabaseQuery' | 'similaritySearch' | 'getCaseCountByPerson' | 'listCasesByPerson' | 'getCaseDetail' | 'getCrimeStatsByCategory' | 'getOfficerPerformance' | 'getTopCrimeDistricts' | 'getRecentAlerts' | 'none';
...
export interface QueryPlan {
  ...
  groupBy?: 'day' | 'month' | 'year' | 'district' | 'station' | string;
  sort?: any;
  limit?: number;
