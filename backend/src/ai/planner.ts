...
export type ToolName = 'executeDatabaseQuery' | 'similaritySearch' | 'getCaseCountByPerson' | 'listCasesByPerson' | 'getCaseDetail' | 'getOfficerPerformance' | 'getTopCrimeDistricts' | 'getRecentAlerts' | 'none';
