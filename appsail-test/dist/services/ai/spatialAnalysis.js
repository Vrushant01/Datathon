...
exports.generateHotspotsRiskAnalysis = exports.performDBSCAN = exports.getDistance = void 0;
...
const generateHotspotsRiskAnalysis = (clusters, allCases) => {
    ...
    return clusters.map((cluster, idx) => {
        ...
        let maxDist = 0;
        cluster.forEach(point => {
            const dist = (0, exports.getDistance)(centerLat, centerLng, point.latitude, point.longitude);
            if (dist > maxDist)
                maxDist = dist;
        });
        ...
        const riskScore = Math.round(frequencyScore * 0.30 +
            trendScore * 0.25 +
            severityScore * 0.20 +
            repeatScore * 0.15 +
            diversityScore * 0.10);
        ...
        if (forecast7DayScore >= 70)
            forecast7DayLevel = "CRITICAL";
        else if (forecast7DayScore >= 50)
            forecast7DayLevel = "HIGH";
        else if (forecast7DayScore >= 30)
            forecast7DayLevel = "MODERATE";
        return {
...
exports.generateHotspotsRiskAnalysis = generateHotspotsRiskAnalysis;
